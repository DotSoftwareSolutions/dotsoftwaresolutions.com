                  ...
                  <div class="col-lg-4">
                     <div class="bd-footer-widget footer-col-1">
                        <div class="bd-footer-widget__title">
                           <a href="index.html">
                              <img src="assets/img/logo/logofooter.svg" alt="">
                           </a>
                        </div>
                        <div class="bd-footer-widget__content">
                           <p>
                              <i>Innovative Solutions for a Digital Future</i>
                              <br>
                              <br>
                              Dot Software Solutions specializes in cutting-edge software development, offering custom web applications, mobile solutions, and AI-powered automation to drive business success.
                           </p>
